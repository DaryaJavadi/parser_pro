...
// **NEW: Enhanced AI Matching Analysis Function**
async function analyzeMatch(candidate, requirements) {
    const prompt = `
You are an expert HR analyst. Analyze how well this candidate matches the given job requirements.
...
1. Calculate a match percentage (0-100) based on:
   ...
   - Educational background alignment (15%)
   - Professional specialty match (20%)

2. Identify specific skills/qualifications that match the requirements

3. Provide clear, detailed reasoning for the percentage including:
   - What matches well
   - What might be missing
   - Overall assessment

4. Be objective and realistic in scoring
5. Consider both hard skills (technical) and soft skills
6. Factor in years of experience relevance

Return ONLY a JSON object with this structure:
{
    "percentage": 85,
    "reasoning": "Strong match with 8+ years experience in required technologies. Has extensive React and Node.js experience matching job requirements. Educational background in Computer Science aligns well. Missing some cloud platform experience but overall excellent fit for the role.",
    "matchedSkills": ["React", "Node.js", "JavaScript", "Communication Skills", "Problem Solving"]
}

Important: Return only valid JSON, no additional text. Be thorough in analysis but concise in reasoning.
    `;
